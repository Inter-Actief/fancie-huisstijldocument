...
Om een poster te ontwerpen hoef je geen expert te zijn op het gebied van ontwerpen. De template is zo ingericht dat met
 ...
 Als je geen Illustrator hebt, of je kan er niet mee werken, dan kan je met onze poster maker een simpele poster maken in de huisstijl.
 Met deze postermaker hoef je alleen maar de tekst, informatie en een afbeelding te uploaden en je poster wordt daarmee gegenereerd.
 De tool kan je op [postermaker.inter-actief.net](https://postermaker.inter-actief.net) vinden.
